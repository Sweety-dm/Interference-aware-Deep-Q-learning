"""Compact implementation of a SRNN_Rainbow agent."""
...
@gin.configurable
class SRNNRainbowAgent(SRNN_dqn_agent.SRNNDQNAgent):
  """A compact implementation of a simplified SRNN_Rainbow agent."""
  ...
  def __init__(self,
               ...
               network=network_model.SRNN_RainbowNetwork,
               num_atoms=51,
               vmax=10.,
               gamma=0.99,
               update_horizon=1,
    ...
    SRNN_dqn_agent.SRNNDQNAgent.__init__(
        self,
        sess=sess,
